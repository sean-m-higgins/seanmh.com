...
See `verification.md` for actual checks and known limitations. Browser screenshots and a walkthrough are generated by the repository scripts; they are evidence for composition and behavior, not proof of subjective equivalence to another artist. The Pages origin and public Worker route were verified on September 21, 2026.
