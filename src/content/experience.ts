...
export const experience: ExperienceEntry[] = [
  {
    ...
    highlights: [
      "OAuth 2.0 subject-matter expert on the API Gateway Platform team — the front door every internal and external API call at the bank flows through, carrying <b class='stat'>10B+ requests</b> and <b class='stat'>150TB+</b> of data a day across <b class='stat'>100k+ clients</b>, peaking at <b class='stat'>200k req/sec</b> with <b class='stat'>99.99%</b> uptime. Own the platform's Authorization Server, which issues <b class='stat'>2B+ OAuth tokens</b> a day at a <b class='stat'>25k/sec</b> production peak — and architected and shipped Workforce SSO, Step-Up Authentication, and a custom Identity Provider integration for consumer sign-in.",
